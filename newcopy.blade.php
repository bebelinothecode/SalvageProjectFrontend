      ...
      <div class="wrapper">
        ...
        <div class="row">
          <div class="col-md-4 form-single-div">
            ...
            <input type="number" class="form-control block-mask text-uppercase" id="quotation_number" name="quotation_number" required>
...
@endphp 
        ...
        <div class="row">
          <div class="col-md-4 form-single-div">
            ...
            <input type="text" id="occupationclass" name="occupationclass" class="form-control block-mask text-uppercase" value="23" readonly>
          </div>
          <div class="col-md-4 form-single-div">
            <label for="numberofmembers">Number of members to be covered</label>
            <input type="number" name="numberofmembers" id="numberofmembers" class="custom-select form-control" required>
          </div>
          <div class="col-md-4 form-single-div">
            <label for="averageage">Average Age</label>
            <input type="number" name="averageage" id="averageage" class="custom-select form-control" required>
          </div>
        </div>
        <div class="row">
          <div class="col-md-4 form-single-div">
    ...
    <div class="row">
        ...
        <div class="row">
          <div class="col-md-4 form-single-div">
            ...
            <input type="number" class="form-control block-mask text-uppercase" id="commissionrate" name="commissionrate" required>
          ...
          <div class="col-md-4 form-single-div">
            <label for="profitloading">Profit Loading</label>
            <input type="number" class="form-control block-mask text-uppercase" id="profitloading" name="profitloading" required>
          </div>
          <div class="col-md-4 form-single-div">
            <label for="expenseloading">Expense Loading</label>
            <input type="number" class="form-control block-mask text-uppercase" id="expenseloading" name="expenseloading" required>
            <!-- <label for="new_business_renewal">New Business or Renewal</label>
            <select name="new_business_renewal" id="new_business_renewal" class="custom-select form-control" required>
              <option> --Select-- </option>
              <option value="New Business">New Business</option>
        ...
        <div class="row">
          <div class="col-md-4 form-single-div">
            ...
            <!-- <input type="number" class="form-control block-mask text-uppercase" id="multipleofsalary" name="multipleofsalary" required> -->
